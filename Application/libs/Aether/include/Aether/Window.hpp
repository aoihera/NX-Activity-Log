...
namespace Aether {
    ...
    class Window {
        ...
        public:
            ...
            /**
             * @brief Discard all screens held on the internal stack without calling onUnload().
             * Call this after deleteScreens() during a full reinit so that stale pointers
             * in the Aether-internal stack cannot cause use-after-free crashes if a pop
             * operation fires after the screens have been deleted.
             */
